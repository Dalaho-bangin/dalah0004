...
if updateMode:
    ...
    if document_check.returncode == 0:
        ...
        subprocess.run([f"wget --no-check-certificate -O {home_dir}/Wordlists/aws-ip-ranges.json https://ip-ranges.amazonaws.com/ip-ranges.json"], stdout=subprocess.DEVNULL, shell=True)
