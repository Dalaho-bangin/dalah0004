...
def get_aws_ip_ranges():
    subprocess.run([f"wget --no-check-certificate -O wordlists/aws-ip-ranges.json https://ip-ranges.amazonaws.com/ip-ranges.json"], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL, shell=True)
